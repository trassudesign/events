...
function renderFullStoreCategoryPills() {
  ...
  shopifyProducts.forEach(p => {
    ...
    if (tagsStr.includes("car") || tagsStr.includes("carro") || typeStr.includes("car")) categoriesPresent.add("cars");
    if (tagsStr.includes("bike") || tagsStr.includes("mota") || tagsStr.includes("moto") || typeStr.includes("bike") || typeStr.includes("mota")) categoriesPresent.add("bikes");
    if (tagsStr.includes("track") || tagsStr.includes("circuito") || typeStr.includes("track") || typeStr.includes("circuit")) categoriesPresent.add("tracks");
    if (tagsStr.includes("helmet") || tagsStr.includes("capacete") || typeStr.includes("helmet")) categoriesPresent.add("helmets");
  });
